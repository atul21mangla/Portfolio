      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="flex space-x-4">
              ...
              <motion.a
                href="https://www.linkedin.com/in/atul-mangla210503/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-[#1a1f29]/60 border border-[#2a303c] hover:border-[rgb(120,198,187)] text-[#b3bac7] hover:text-[rgb(120,198,187)] transition-all duration-300"
                aria-label="LinkedIn"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
              >
                <a href="https://drive.google.com/file/d/1ema901HUuOW422dQqCWEdFCH_O7ufOKs/view?usp=sharing" download target="_blank" className="flex items-center">
                  Download Resume
                </a>
              </motion.button>
            </div>
        ...
        >
          <p className="text-[#b3bac7] text-sm font-medium">
            © {currentYear} Atul Mangla. All rights reserved.
          </p>
